...
#elif NET_SERVE == 1
// 物联网开发平台（阿里云支持）
#define ServerIP "iot-06z00io8yqoxncb.mqtt.iothub.aliyuncs.com" // 服务器IP地址
...
#endif
// 设备信息
#define PROID "6-6-device"															 // 产品ID
#define DEVID "6-6-device" // 设备ID
#define AUTH_INFO "6-6-device"						 // 鉴权信息
// MQTT主题 /broadcast/
#define S_TOPIC_NAME "/broadcast/66/test1" // 需要订阅的主题
#define P_TOPIC_NAME "/broadcast/66/test2" // 需要发布的主题
