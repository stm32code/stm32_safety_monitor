...
U32 addrShort3 = 0x0800C000 + 13 * 16; // 1

void W_Test(void)
{

  System_WriteInteriorFlash(addrShort1, (uint8_t *)&threshold_value_init.heart_value, sizeof(threshold_value_init.heart_value)); // 存入数据，函数内自动解锁，擦除，写入
  System_WriteInteriorFlash(addrShort2, (uint8_t *)&threshold_value_init.temp_value, sizeof(threshold_value_init.temp_value));
	System_WriteInteriorFlash(addrShort3, (uint8_t *)&threshold_value_init.spo2_value, sizeof(threshold_value_init.spo2_value));
	
}
// 读取数据
void R_Test(void)
{
	System_ReadInteriorFlash(addrShort1, (uint8_t *)&threshold_value_init.heart_value, sizeof(threshold_value_init.heart_value)); // 存入数据，函数内自动解锁，擦除，写入
  System_ReadInteriorFlash(addrShort2, (uint8_t *)&threshold_value_init.temp_value, sizeof(threshold_value_init.temp_value));
	System_ReadInteriorFlash(addrShort3, (uint8_t *)&threshold_value_init.spo2_value, sizeof(threshold_value_init.spo2_value));
